...
<ParamField query="scenario" type="string" enum="[beach, deserat, plain, taiga, mountain, snow, jungle, city, underwater, urban, forest, desert, beach, plain, mountain, snow, jungle, city, underwater, urban, forest, desert]">
