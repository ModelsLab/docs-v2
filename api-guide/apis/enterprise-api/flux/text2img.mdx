...
<Warning>
  Make sure you add your [s3 details](/api-guide/apis/enterprise-api/general/update-s3-details.mdx) for `flux` server, so you can receive image generated in your bucket. 
