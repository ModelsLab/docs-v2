...
<Update label="2026-03-25" description="Docs: UI & Structure Updates">
  ## Docs UI & Structure Updates

  A series of improvements to the docs site structure, navigation, and styling.

  #### Navigation
  - Renamed **Release Notes** tab to **Changelog** — consolidated into a single page
  - Removed Support link from navbar
  - Added native Discord branded icon to navbar
  - Added external link icon to `modelslab.com` navbar button
  - Removed Perplexity, VS Code, and Feature Requests from contextual options

  #### Visuals
  - Cards now use sharper corners (`border-radius: 4px`) across the site
  - Updated hero image on Song Generation Guide and Changelog entry to new asset

  #### Agent Skills Page
  - Removed all emojis from the Available Skills tables

  #### Agent Instructions
  - Added `.claude/CLAUDE.md` with project instructions to always update changelog on every change
</Update>
...
<Update label="2025-02-05" description="Song Generator API: ACE-Step v1.5 Model">
  <Frame>
    <img
      src="https://assets.modelslab.ai/generations/4d9b3cca-cf31-4435-8829-932ec4ca481e.png"
