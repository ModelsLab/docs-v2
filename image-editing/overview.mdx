...
<CardGroup cols={2}>
  ...
  <Card title="Flux Kontext Image to Image" href="/image-editing/flux-kontext-img-to-image" img="">
    Create and edit high quality images from text and Image combined using FLUX Kontext Dev model.
  </Card>
