---
title: PHP
description: "The client for PHP provides a seamless interface to interact with Modelslab API."
---
...
Link to the Github repository: [modelslab-php](https://github.com/Modelslab/modelslab-php)
