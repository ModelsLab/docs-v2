...
The Agent Control Plane MCP server lets AI agents manage a full ModelsLab account lifecycle without a browser. It exposes the [Agents API (Control Plane)](/agents-api/overview) as 10 MCP tools covering authentication, profile management, API keys, usage analytics, model discovery, billing, wallet, subscriptions, and teams.
