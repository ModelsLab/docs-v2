...
<CardGroup>
  ...
  <Card title="Cancel Subscription" href="/general-api/cancel-subscription">
  ...
  <Card title="NSFW Image Check" href="/general-api/nsfw-image-check">
    This endpoint is useful to check if an image is nsfw or not.
  </Card>
  <Card title="NSFW Prompt Check" href="/general-api/nsfw-prompt-check">
