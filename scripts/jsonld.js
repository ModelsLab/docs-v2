  ...
  var schemas = [
    {
      ...
      "description":
        "Complete developer documentation for ModelsLab's AI API suite. Generate images, videos, audio, and 3D models with 10,000+ AI models.",
      "publisher": {
        "@type": "Organization",
        "name": "ModelsLab",
      ...
      "potentialAction": {
        ...
        "target": {
          "@type": "EntryPoint",
          "urlTemplate":
            "https://docs.modelslab.com/search?q={search_term_string}",
        },
