---
title: "Inpaint"
description: "Generate high-definition image from init image and mask image using qwen model."
---

## Request
Make a `POST` request to below endpoint and pass the required parameters in the request body.
```curl curl
--request POST 'https://modelslab.com/api/v1/enterprise/qwen/inpaint' \
```
...
```json json
{
  ...
  "init_image": "https://gitlab.com//-/project/50380374/uploads/990f9affc05324a5c467b4990e5167eb/image.png",
  "mask_image": "https://gitlab.com//-/project/50380374/uploads/990f9affc05324a5c467b4990e5167eb/image.png",
  "width": 1024,
  "height": 1024,
  "samples": 1,
  "track_id":null,
