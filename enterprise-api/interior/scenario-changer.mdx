...
description: "Swap the surroundings of a space to preview how the home looks in different scenarios."
---
...
<ParamField query="prompt" type="string">
  A text description of the desired scenario or surroundings for the image.
</ParamField>
