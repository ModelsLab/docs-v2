...
description: "This endpoint generates an image from a text prompt and init image using z image turbo model."
---
...
```curl curl
--request POST 'https://modelslab.com/api/v1/enterprise/z_image_turbo/img2img' \
```
...
<ParamField query="init_image" type="string" required placeholder="Image URL">
