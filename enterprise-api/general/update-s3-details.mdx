...
<ParamField body="deploy_type" type="string">
  This is the server type you want to add the S3 details for. Options: `text_to_image`, `image_editing`, `voice_cloning`, `text_to_3d`, `video`, `face_gen`, `deepfake`, `realtime`, `super_resolution`, `flux`, `flux_headshot`, `interior`, `qwen_imagen_server`, `qwen_edit_2511`, `qwen_edit_bundle`, `qwen_tts`, `flux_kontext_dev`, `image_to_video_ultra_wan22`, `video_server_ultra_wan22,z_image_turbo,z_image_base`. Default: `text_to_image`.
</ParamField>
