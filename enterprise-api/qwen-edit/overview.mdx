...
<CardGroup cols={2}>
  ...
  <Card title="Magic Mix" icon="shuffle" href="/enterprise-api/qwen-edit/magic-mix">
    Generate eye-catching image blends with text prompts
  </Card>

  <Card title="Object Removal" icon="eraser" href="/enterprise-api/qwen-edit/object-removal">
