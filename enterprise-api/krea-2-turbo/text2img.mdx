---
title: "Text to Image"
description: "This endpoint generates an image from a text prompt using Krea 2 Turbo model."
---

<Warning>
  Make sure you add your [s3 details](/enterprise-api/general/update-s3-details.mdx) for `krea_2_turbo` server, so you can receive image generated in your bucket. 
...
```curl curl
--request POST 'https://modelslab.com/api/v1/enterprise/krea_2_turbo/text2img' \
```
