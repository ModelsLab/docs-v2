...
<ParamField path="ref_image" type="string" required>
...
<ParamField path="noise_scale_start" type="number" min="0" max="30" default="7.5">
  Starting noise scale for the generation process.
</ParamField>

<ParamField path="noise_scale_end" type="number" min="0" max="30" default="7.5">
  Ending noise scale for the generation process.
</ParamField>

<ParamField path="noise_clip_std" type="number" min="0" max="10" default="2.5">
  Noise clip standard deviation.
</ParamField>

<ParamField path="keep_original_aspect" type="string" default="no">
  Keep the original aspect ratio of the reference image. Only applies when using a single reference image. Values: "yes" or "no".
</ParamField>

<ParamField path="watermark" type="string" default="no">
  Whether to add a watermark to the generated image. Values: "yes" or "no".
</ParamField>

<ParamField path="temp" type="string" default="no">
  Store in temporary directory. Values: "yes" or "no".
</ParamField>

<ParamField path="base64" type="string" default="no">
